...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self):
        response = self.client.get('/catalog/author/')  # checks a specific URL
    ...
    def test_view_uses_correct_template(self):
        # generates the URL from it's name in the URL configuration
        response = self.client.get(reverse('author'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_pagination_is_ten(self):
        ...
        # context variable passed to the template by the view
